...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(DepartmentCodeAlreadyRegisteredException.class)
    public ResponseEntity<ErrorDetails> departmentCodeAlreadyRegistered(
            DepartmentCodeAlreadyRegisteredException exception, WebRequest request
    ){
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        errors.put("Request Body me galti h"," Thik kro....");
